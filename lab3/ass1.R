...
#plot(density(rainfall$V1))
set.seed(12345)
n = length(rainfall)

# a
mu_0 = mean(rainfall)
sigma2_0 = 1#var(rainfall)
v_0 = 1
...
pdf('plots/mixture.pdf', width=imgw, height=imgh)
...
pdf('plots/muMixed.pdf', width=imgw, height=imgh)
...
dev.off()
pdf('plots/sigmaMixed.pdf', width=imgw, height=imgh)
